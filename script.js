...
var cursur=document.querySelector(".page5")

cursur.addEventListener("mousemove",function(elm){
...
cursur.addEventListener("mouseenter",function(elm){
...
cursur.addEventListener("mouseleave",function(elm){
